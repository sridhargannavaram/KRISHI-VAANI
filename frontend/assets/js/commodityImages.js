...
(function (root, factory) {
  ...
  const LOCAL_COMMODITY_REGISTRY = {
    // Solanaceae & Alliums
    'tomato': LOCAL_IMAGE_BASE + 'tomato.webp',
    'onion': LOCAL_IMAGE_BASE + 'onion.webp',
    'onion_green': LOCAL_IMAGE_BASE + 'onion-green.webp',
    'potato': LOCAL_IMAGE_BASE + 'potato.webp',
    'sweet_potato': LOCAL_IMAGE_BASE + 'sweet-potato.webp',
    'garlic': LOCAL_IMAGE_BASE + 'garlic.webp',
    'ginger': LOCAL_IMAGE_BASE + 'ginger.webp',
    'carrot': LOCAL_IMAGE_BASE + 'carrot.webp',
    'radish': LOCAL_IMAGE_BASE + 'radish.webp',
    'turnip': LOCAL_IMAGE_BASE + 'turnip.webp',
    ...
    'dry_chilli': LOCAL_IMAGE_BASE + 'dry-chilli.webp',
    'capsicum': LOCAL_IMAGE_BASE + 'capsicum.webp',
    'cucumber': LOCAL_IMAGE_BASE + 'cucumber.webp',
    'bottle_gourd': LOCAL_IMAGE_BASE + 'bottle-gourd.webp',
    'bitter_gourd': LOCAL_IMAGE_BASE + 'bitter-gourd.webp',
    'ridge_gourd': LOCAL_IMAGE_BASE + 'ridge-gourd.webp',
    'sponge_gourd': LOCAL_IMAGE_BASE + 'sponge-gourd.webp',
    'snake_gourd': LOCAL_IMAGE_BASE + 'snake-gourd.webp',
    'ash_gourd': LOCAL_IMAGE_BASE + 'ash-gourd.webp',
    'pointed_gourd': LOCAL_IMAGE_BASE + 'pointed-gourd.webp',
    'pumpkin': LOCAL_IMAGE_BASE + 'pumpkin.webp',
    'coriander': LOCAL_IMAGE_BASE + 'coriander.webp',
    'mint': LOCAL_IMAGE_BASE + 'mint.webp',
    'mentha': LOCAL_IMAGE_BASE + 'mentha.webp',
    'methi': LOCAL_IMAGE_BASE + 'methi.webp',
    'spinach': LOCAL_IMAGE_BASE + 'spinach.webp',
    ...
    'cowpea': LOCAL_IMAGE_BASE + 'cowpea.webp',
    'mushroom': LOCAL_IMAGE_BASE + 'mushroom.webp',

    // Grains, Cereals & Millets
    'wheat': LOCAL_IMAGE_BASE + 'wheat.webp',
    'wheat_atta': LOCAL_IMAGE_BASE + 'wheat-atta.webp',
    'rice': LOCAL_IMAGE_BASE + 'rice.webp',
    'paddy': LOCAL_IMAGE_BASE + 'paddy.webp',
    'maize': LOCAL_IMAGE_BASE + 'maize.webp',
    'sweet_corn': LOCAL_IMAGE_BASE + 'sweet-corn.webp',
    'baby_corn': LOCAL_IMAGE_BASE + 'baby-corn.webp',
    'jowar': LOCAL_IMAGE_BASE + 'jowar.webp',
    'bajra': LOCAL_IMAGE_BASE + 'bajra.webp',
    ...
    'wood': LOCAL_IMAGE_BASE + 'wood.webp',
    'coconut': LOCAL_IMAGE_BASE + 'coconut.webp',
    'tender_coconut': LOCAL_IMAGE_BASE + 'tender-coconut.webp',
    'copra': LOCAL_IMAGE_BASE + 'copra.webp',
    'coconut_oil': LOCAL_IMAGE_BASE + 'coconut-oil.webp',
    'arecanut': LOCAL_IMAGE_BASE + 'arecanut.webp',
    'betel_leaf': LOCAL_IMAGE_BASE + 'betel-leaf.webp',
    'jaggery': LOCAL_IMAGE_BASE + 'jaggery.webp',

    // Flowers
    'jasmine': LOCAL_IMAGE_BASE + 'jasmine.webp',
    'marigold': LOCAL_IMAGE_BASE + 'marigold.webp',
    'rose': LOCAL_IMAGE_BASE + 'rose.webp',
    'gerbera': LOCAL_IMAGE_BASE + 'gerbera.webp',

    // Spices & Essential Oils
    'mentha_oil': LOCAL_IMAGE_BASE + 'mentha-oil.webp',
    'cumin': LOCAL_IMAGE_BASE + 'cumin.webp',
    'mustard': LOCAL_IMAGE_BASE + 'mustard.webp',
    'turmeric': LOCAL_IMAGE_BASE + 'turmeric.webp',
    'tamarind': LOCAL_IMAGE_BASE + 'tamarind.webp',

    // Oilseeds & Pulses
    'groundnut': LOCAL_IMAGE_BASE + 'groundnut.webp',
    'sesamum': LOCAL_IMAGE_BASE + 'sesamum.webp',
    'castor_seed': LOCAL_IMAGE_BASE + 'castor-seed.webp',
    'soybean': LOCAL_IMAGE_BASE + 'soybean.webp',
    'bengal_gram': LOCAL_IMAGE_BASE + 'bengal-gram.webp',
    'red_gram': LOCAL_IMAGE_BASE + 'red-gram.webp',
    'green_gram': LOCAL_IMAGE_BASE + 'green-gram.webp',
    'horse_gram': LOCAL_IMAGE_BASE + 'horse-gram.webp',
    'lentil': LOCAL_IMAGE_BASE + 'lentil.webp',

    // Fruits
    'banana': LOCAL_IMAGE_BASE + 'banana.webp',
    'banana_green': LOCAL_IMAGE_BASE + 'banana-green.webp',
    'mango': LOCAL_IMAGE_BASE + 'mango.webp',
    'papaya': LOCAL_IMAGE_BASE + 'papaya.webp',
    'custard_apple': LOCAL_IMAGE_BASE + 'custard-apple.webp',
    'pineapple': LOCAL_IMAGE_BASE + 'pineapple.webp',
    'apple': LOCAL_IMAGE_BASE + 'apple.webp',
    'pomegranate': LOCAL_IMAGE_BASE + 'pomegranate.webp',
    'lemon': LOCAL_IMAGE_BASE + 'lemon.webp',
    'sweet_lime': LOCAL_IMAGE_BASE + 'sweet-lime.webp',
    'orange': LOCAL_IMAGE_BASE + 'orange.webp',
    'grapes': LOCAL_IMAGE_BASE + 'grapes.webp',
    'watermelon': LOCAL_IMAGE_BASE + 'watermelon.webp',
    'muskmelon': LOCAL_IMAGE_BASE + 'muskmelon.webp',
    'guava': LOCAL_IMAGE_BASE + 'guava.webp',
    'jackfruit': LOCAL_IMAGE_BASE + 'jackfruit.webp',
    'amla': LOCAL_IMAGE_BASE + 'amla.webp',
    'fig': LOCAL_IMAGE_BASE + 'fig.webp',
    'pear': LOCAL_IMAGE_BASE + 'pear.webp',
    'plum': LOCAL_IMAGE_BASE + 'plum.webp',
    'chikoo': LOCAL_IMAGE_BASE + 'chikoo.webp'
  };
