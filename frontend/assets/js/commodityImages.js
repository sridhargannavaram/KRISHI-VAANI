...
(function (root, factory) {
  ...
  const LOCAL_COMMODITY_REGISTRY = {
    ...
    // Newly Connected Produce
    'black_gram': LOCAL_IMAGE_BASE + 'Black Gram (Urad).png',
    'cowpea': LOCAL_IMAGE_BASE + 'cowpea.png',
    'guava': LOCAL_IMAGE_BASE + 'Guava.png',
    'pepper': LOCAL_IMAGE_BASE + 'pepper.png',
    'custard_apple': LOCAL_IMAGE_BASE + 'custard-apple.jpg',
    'sugarcane': LOCAL_IMAGE_BASE + 'sugarcane.jpg',
    'sunflower': LOCAL_IMAGE_BASE + 'sunflower.jpg',
